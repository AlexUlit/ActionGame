                            ...
                            const FGameplayAbilityActivationInfo ActivationInfo, FGameplayTagContainer* OptionalRelevantTags)
{
	...
	const float VerticalTraceLength = FMath::Abs(JumpToLocation.Z - (JumpToLocation + i * UpVector * HorizontalTraceStep).Z);
	...
	const FGameplayAbilityActivationInfo ActivationInfo, bool bReplicateEndAbility, bool bWasCancelled)
{
	...
	UAG_MotionWarpingComponent* MotionWarpingComponent = Character->GetMotionWarpingComponent();
